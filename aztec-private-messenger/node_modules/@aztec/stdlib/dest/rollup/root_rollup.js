 ...
 */ export class RootRollupPublicInputs {
    ...
    proverId;
    blobPublicInputs;
    constructor(/** Snapshot of archive tree before/after this rollup been processed */ previousArchive, endArchive, previousBlockHash, endBlockHash, // This is a u64 in nr, but GlobalVariables contains this as a u64 and is mapped to ts as a field, so I'm doing the same here
   ...
   */ static fromBuffer(buffer) {
    ...
    /** Creates a random instance. */ static random() {
        return new RootRollupPublicInputs(AppendOnlyTreeSnapshot.random(), AppendOnlyTreeSnapshot.random(), Fr.random(), Fr.random(), Fr.random(), Fr.random(), Fr.random(), makeTuple(AZTEC_MAX_EPOCH_DURATION, FeeRecipient.random), Fr.random(), Fr.random(), Fr.random(), makeTuple(AZTEC_MAX_EPOCH_DURATION, BlockBlobPublicInputs.empty));
    }
}
