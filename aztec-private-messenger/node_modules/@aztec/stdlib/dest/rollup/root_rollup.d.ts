...
export declare class RootRollupPublicInputs {
    ...
    constructor(
    /** Snapshot of archive tree before/after this rollup been processed */
    previousArchive: AppendOnlyTreeSnapshot, endArchive: AppendOnlyTreeSnapshot, previousBlockHash: Fr, endBlockHash: Fr, endTimestamp: Fr, endBlockNumber: Fr, outHash: Fr, fees: Tuple<FeeRecipient, typeof AZTEC_MAX_EPOCH_DURATION>, vkTreeRoot: Fr, protocolContractTreeRoot: Fr, proverId: Fr, blobPublicInputs: Tuple<BlockBlobPublicInputs, typeof AZTEC_MAX_EPOCH_DURATION>);
    static getFields(fields: FieldsOf<RootRollupPublicInputs>): readonly [AppendOnlyTreeSnapshot, AppendOnlyTreeSnapshot, Fr, Fr, Fr, Fr, Fr, [FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient, FeeRecipient], Fr, Fr, Fr, [BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs, BlockBlobPublicInputs]];
    toBuffer(): Buffer;
    toFields(): Fr[];
