...
export declare class UserDefiTx {
    ...
    constructor(txId: TxId, userId: GrumpkinAddress, bridgeCallData: BridgeCallData, depositValue: AssetValue, fee: AssetValue, created: Date, settled: Date | undefined, interactionResult: UserDefiInteractionResult);
}
