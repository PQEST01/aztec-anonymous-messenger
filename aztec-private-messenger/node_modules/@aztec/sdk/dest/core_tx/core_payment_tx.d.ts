...
export declare class CorePaymentTx {
    ...
    constructor(txId: TxId, userId: GrumpkinAddress, proofId: PaymentProofId, assetId: number, publicValue: bigint, publicOwner: EthAddress | undefined, privateInput: bigint, recipientPrivateOutput: bigint, senderPrivateOutput: bigint, isRecipient: boolean, isSender: boolean, txRefNo: number, created: Date, settled?: Date | undefined);
}
...
export declare const createCorePaymentTxForRecipient: ({ txId, userId, proofId, assetId, publicValue, publicOwner, privateInput, recipientPrivateOutput, senderPrivateOutput, txRefNo, created, settled, }: CorePaymentTx, recipient: GrumpkinAddress) => CorePaymentTx;
