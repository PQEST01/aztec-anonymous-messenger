...
export declare class DefiInteractionEvent {
    ...
    constructor(bridgeCallData: BridgeCallData, nonce: number, totalInputValue: bigint, totalOutputValueA: bigint, totalOutputValueB: bigint, result: boolean, errorReason?: Buffer);
