...
export declare enum RollupProofDataFields {
    ...
    OLD_DEFI_ROOT = 9,
    NEW_DEFI_ROOT = 10,
    BRIDGE_CALL_DATAS = 11,
    DEFI_DEPOSIT_SUMS,
    FEE_ASSET_IDS,
    FEE_SUMS,
    DEFI_INTERACTIONS,
    PREV_DEFI_INTERACTION_HASH,
    ROLLUP_BENEFICIARY,
    NUM_ROLLUP_TXS
}
...
export declare class RollupProofData {
    ...
    rollupHash_?: Buffer;
    constructor(rollupId: number, rollupSize: number, dataStartIndex: number, oldDataRoot: Buffer, newDataRoot: Buffer, oldNullRoot: Buffer, newNullRoot: Buffer, oldDataRootsRoot: Buffer, newDataRootsRoot: Buffer, oldDefiRoot: Buffer, newDefiRoot: Buffer, bridgeCallDatas: Buffer[], defiDepositSums: bigint[], assetIds: number[], totalTxFees: bigint[], defiInteractionNotes: Buffer[], prevDefiInteractionHash: Buffer, rollupBeneficiary: Buffer, numRollupTxs: number, innerProofData: InnerProofData[]);
    ...
    static getBridgeCallDatas(proofData: Buffer): Buffer[];
    ...
    static randomData(rollupId: number, numTxs: number, dataStartIndex?: number, innerProofData?: InnerProofData[], bridgeCallDatas?: BridgeCallData[]): RollupProofData;
