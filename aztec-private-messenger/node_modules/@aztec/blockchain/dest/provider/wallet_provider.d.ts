...
import { EthereumProvider, ProviderConnectInfo, ProviderMessage, ProviderRpcError, RequestArguments } from '@aztec/barretenberg/blockchain';
...
export declare class WalletProvider implements EthereumProvider {
    ...
    addAccountsFromMnemonic(mnemonic: string, num: number, bip32Account?: number): void;
    addAccountFromMnemonicAndPath(mnemonic: string, path: string): EthAddress;
    addAccountFromKeystore(file: string, password?: string): void;
